exp_name = 'vsr_red_train_st2_128x'
...
train_pipeline = [
    ...
    dict(
        ...
        key='gt',
        channel_order='rgb'),
    dict(type='FixedCrop', keys=['gt'], crop_size=(gt_crop_sz, gt_crop_sz)),
        ...
        degradations=[
            ...
            [
                dict(
                    type='RandomResize',
                    params=dict(
                        target_size=(gt_crop_sz // upsample_scale, gt_crop_sz // upsample_scale),
                        resize_opt=['bilinear', 'area', 'bicubic'],
                        resize_prob=[1 / 3., 1 / 3., 1 / 3.]),
                ),
                dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='data/REDS/train_sharp_bicubic/X2_sub',
            gt_folder='data/REDS/train_sharp_bicubic/X2_sub',
            ann_file="anno_f.txt",
            num_input_frames=15,
...
# optimizer
optimizers = dict(
    generator=dict(type='Adam', lr=1e-6, betas=(0.9, 0.99)),
    discriminator=dict(type='Adam', lr=5e-5, betas=(0.9, 0.99)))
...
# load_from = 'experiments/vsr_train_st1/latest.pth'
load_from = "checkpoints/RealBasicVSR_x4.pth"
resume_from = "experiments/vsr_red_train_st2_128x/latest.pth"
workflow = [('train', 1)]
